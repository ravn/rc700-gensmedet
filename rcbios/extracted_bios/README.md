...
**Reconstructed (2026-07-02):** `make rc703-rel11` builds `src-rc703/BIOS_REL11.MAC`
and `make verify-rc703-rel11` confirms **byte-identical** (9600/9600) to this
reference.  The source was auto-generated by `src-rc703/mkbios_rel11.py`, which
address-shifts rel.1.2's data-region map through the difflib diff (rel.1.1 lacks
two 512-B blocks rel.1.2 inserted → code_end 0xE600 instead of 0xEA00).
